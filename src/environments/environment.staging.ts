export const environment = {
  ...
  analytics: {
    ...
    tagLabels: [
      ...
      {
        name: 'NOT ACTUALLY SWING',
        tag_key: 'notswing',
        progress_bar_type: 'danger',
        option_text: 'manual',
      },
      {
        name: 'NOT PROCESS YET',
        tag_key: 'uncheck',
        progress_bar_type: 'danger',
        option_text: 'uncheck',
      },
  ...
  tag_types: [
    {
      ...
      description:
        'Seperate type of music by in genre. Like Swing, Blues, Soul, Rock, Gospel, Rhythm and Blues, Doowop, Pop or Other. Some music could have more than one genre too.',
      tags: {
        blues: 'Blues',
        soul: 'Soul',
        rock: 'Rock',
    ...
    },
    {
      name: 'Dance',
      description:
        'Seperate type of music by dancing. Like Lindy hop, Balboa, Charleston, Blues, Charleston or Other.  Some music could have more than one dancing and sometime it have not been tagged yet',
    ...
    },
    {
      name: 'Artist',
      description:
        'Seperate type of track by era of artist. Either Classic (20s - 50s), Modern (80s - now) or Other(50s - 80s)',
  ...
  hideFooterPaths: ['/', '/battle', '/battle/vote'],
};
